...
def main():
    ...
    parser.add_argument('--model-file', type=str, default='/ai/sjq/mylab/VAE/logs/Domain4/20211026_092153.833101/checkpoint_200.pth.tar',
                        help='Model path')
    parser.add_argument(
    ...
    parser.add_argument(
        '--mask-dir',
        required=True,
        default='/ai/sjq/dataset/Fundus/Domain3/ROIs/test/mask',
    ...
    db_test = DL.FundusSegmentation(base_dir=args.data_dir, dataset=args.dataset, split='test/ROIs',
